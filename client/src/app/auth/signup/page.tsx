...
export const metadata: Metadata = {
  title: "Next.js SignUp Page | Maya Collab - Next.js Dashboard Template",
  description: "This is Next.js SignUp Page Maya Collab Dashboard Template",
  // other metadata
};
