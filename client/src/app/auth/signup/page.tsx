...
export const metadata: Metadata = {
  title: "Next.js SignUp Page | MemoFusion - Next.js Dashboard Template",
  description: "This is Next.js SignUp Page MemoFusion Dashboard Template",
  // other metadata
};
