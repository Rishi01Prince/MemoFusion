...
export const metadata: Metadata = {
  title: "Next.js Profile | Maya Collab - Next.js Dashboard Template",
  description:
    "This is Next.js Profile page for Maya Collab - Next.js Tailwind CSS Admin Dashboard Template",
};
